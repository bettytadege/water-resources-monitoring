...
const watershedSelectOption = [
  { label: "Blue Nile", value: "blueNile" },
  { label: "White Nile", value: "whiteNile" },
  { label: "Awash Basin", value: "awashBasin" },
  { label: "Omo Gibe", value: "omoGibe" },
];
    ...
    <>
      <CardContainer className="flex flex-col gap-6">
        <div className="flex justify-between">
                    <InfoBlock icon={LuLayers } title="Water Visualization"  description="Interactive watershed boundaries and water bodies"/>

          {/* select */}
         <SelectField item={watershedSelectOption} defaultValue="blueNile"/>
        </div>
